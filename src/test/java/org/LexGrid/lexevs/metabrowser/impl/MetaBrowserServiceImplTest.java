...
public class MetaBrowserServiceImplTest {
	...
	@Test
	public void testGetCountSouceTabSourceOf() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
	...
	@Test
	public void testGetCountSouceTabSourceOfExcludeSelfReferencingFalse() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
		MetaBrowserService impl = new MetaBrowserServiceImpl();
	...
	@Test
	public void testGetCountSouceTabSourceOfExcludeSelfReferencingTrue() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
		MetaBrowserService impl = new MetaBrowserServiceImpl();
	...
	@Test
	public void testGetCountSouceTabTargetOf() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
		MetaBrowserService impl = new MetaBrowserServiceImpl();
	...
	@Test
	public void testGetCountSouceTabTargetOfExcludeSelfReferencingTrue() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
		MetaBrowserService impl = new MetaBrowserServiceImpl();
	...
	@Test
	public void testGetCountSouceTabTargetOfExcludeSelfReferencingFalse() throws Exception {
		System.setProperty("LG_CONFIG_FILE", "src/test/resources/config/lbconfig.props");
		MetaBrowserService impl = new MetaBrowserServiceImpl();
